...
let
  ...
  hashes = {
    x86_64-linux = {
      ...
      canary = "sha256-EkL55AeVa2Qhzpn5SgyS/JlICRyqqBj3D1FOpFHgAJY=";
    ...
    x86_64-darwin = {
      ...
      canary = "sha256-EXvekHXqchCkpq/ClOi+ptSAAAlBj3thRXVdBdl3tow=";
      development = "sha256-Hq+QECXfmwF1BOexVqspmsejh2v5Pg25AUZOWXmoZOQ=";
    };
  };
